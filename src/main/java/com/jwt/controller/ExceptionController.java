...
public class ExceptionController {
    ...
    public ResultResponse handle401() {
        return new ResultResponse(401, "Unauthorized", null);
    }

    // 捕捉其他所有异常
    @ExceptionHandler(Exception.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResultResponse globalException(HttpServletRequest request, Throwable ex) {
        return new ResultResponse(getStatus(request).value(), ex.getMessage(), null);
    }
